...
describe('getSubTotal function', () => {
  ...
  test('It should return 0', () => {
    ...
    expect(getSubTotal([{ ...coke, price: -199 }])).toBe(0);
  ...
  test('It should return the correct amount', () => {
    expect(getSubTotal([coke])).toBe(70);
    expect(getSubTotal([coke, coke, coke])).toBe(210);
    expect(getSubTotal([coke, oranges])).toBe(269);
  });
});
